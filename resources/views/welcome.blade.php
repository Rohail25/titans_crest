...
<body class="bg-gray-50">
    ...
    <aside id="mobileMenuPanel" class="fixed top-0 left-0 h-full w-72 max-w-[85%] bg-[#062a5f] border-r border-[#d4af37]/30 transition-transform duration-300 ease-out md:hidden" style="z-index: 70; transform: translateX(-100%); background-color: #062a5f">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6 sm:gap-8 items-start !grid">
                ...
                <div class="bg-[#0b2f66] rounded-2xl p-8 shadow-lg border-2 border-[#d4af37] card-hover relative text-white">
                    ...
                    <a href="/register" class="block w-full bg-white  text-center py-3 rounded-lg font-bold hover:bg-[#e1c263] transition text-[#062a5f]" style="background-color: white; color: #062a5f;">Choose Plan</a>
                </div>
            </div>
        </div>
    </section>

    <!-- 5-Level Referral Plan -->
    <section class="py-20 px-4 sm:px-6 lg:px-8 gradient-bg" style="margin-top: 60px;">
        <div class="max-w-4xl mx-auto">
            <div class="text-center mb-10">
                <h2 class="text-4xl font-bold text-white mb-2">5-Level Referral Plan</h2>
